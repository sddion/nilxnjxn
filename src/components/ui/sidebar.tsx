  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'group peer text-sidebar-foreground hidden w-[--sidebar-width] shrink-0 flex-col transition-[width] duration-200 ease-linear data-[state=collapsed]:w-[--sidebar-width-icon] md:flex',
          className,
        )}
        data-state={state}
