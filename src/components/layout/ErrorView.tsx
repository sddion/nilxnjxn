...
export function ErrorView({ code, title, description, glowColor = 'bg-red-500/10' }: ErrorViewProps) {
  return (
    <main className="bg-background relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 pt-20">
      ...
      <div className="pointer-events-none fixed inset-0 z-0 opacity-20">
        <div className={`absolute top-1/2 left-1/2 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full blur-[200px] ${glowColor}`} />
      </div>
